...
#
# run_save_checkpoint / run_load_checkpoint removed along with the checkpointing problem
# (part of "Training Loop" -- cut, see project notes). No resumable multi-step training
# loop remains in this assignment, so checkpoint serialization has nothing to attach to.
